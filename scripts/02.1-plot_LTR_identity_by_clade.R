# In this script, we analyze the identity of full-length LTR retrotransposons (LTR-RTs) annotated in a genome. We read a GFF file with LTR-RT annotations, extract the LTR identity values, merge with classification data from TEsorter, and generate plots showing the distribution of LTR identities per clade within the Copia and Gypsy superfamilies.
...
#-------------------------------------------------
gff_file <- "Elh-2.asm.bp.p_ctg.fa.mod.LTR.intact.raw.gff3"
cls_file <- "Elh-2.asm.bp.p_ctg.fa.mod.LTR.raw.fa.rexdb-plant.cls.tsv"
...
# ggsave("plots/02.1_LTR_Copia_Gypsy_cladelevel.png", combined, width = 12, height = 10, dpi = 300)
ggsave("plots/02.1_LTR_Copia_Gypsy_cladelevel.pdf", combined, width = 12, height = 10)