...
ggsave(filename = "plots/04.3-TE_age_estimation.pdf", width = 10, height = 5, useDingbats = F)

# Why is it important to have this plot in Mbp instead of counts? 
# Hint: consider a scenario where there is a lot of small fragments of TEs due to nested insertions and deletions.
